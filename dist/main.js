...
const settings = {
    ...
    REMOTE_URL_SOURCE_ALLOW_ORIGIN: "*",
    THROTTLE_TASK: true,
    THROTTLE_TASK_DEFAULT: 5,
    SERVER_PORT: 5000,
};
...
function resize(req, res) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      }); // const task = data.body.pipe(resize(type, imgQuality, size)).pipe(res);
...
polka().get("/", (req, res) => {}).get("/resize", resize).listen(PORT, err => {
  if (err) throw err;
